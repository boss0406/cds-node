...
public class ByteUtil {
    ...
    public static String toHexStringWith0x(byte[] data) {
    	String result = data == null ? "" : Hex.toHexString(data);
        return StringUtils.startsWithIgnoreCase(result, "0x")?StringUtils.lowerCase(result):StringUtils.lowerCase("0x"+result);
    }
