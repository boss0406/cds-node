...
import static org.cds.main.blockchain.crypto.HashUtil.*;
import static org.cds.main.blockchain.util.ByteUtil.toHexString;
import static org.cds.main.blockchain.util.FastByteComparisons.equal;
...
public class AccountState {
     ...
     * The hash is formally denoted 蟽[a] s .
     *
     * Since I typically wish to refer not to the trie鈥檚 root hash
     * but to the underlying set of key/value pairs stored within,
     * I define a convenient equivalence TRIE (蟽[a] s ) 鈮� 蟽[a] s .
     * It shall be understood that 蟽[a] s is not a 鈥榩hysical鈥� member
     * of the account and does not contribute to its later serialisation */
    private final byte[] stateRoot;

    /* The hash of the EVM code of this contract鈥攖his is the code
