...
import org.cds.main.blockchain.net.swarm.bzz.BzzPeersMessage;
import org.cds.main.blockchain.net.swarm.bzz.BzzProtocol;
import org.cds.main.blockchain.net.swarm.bzz.PeerAddress;
...
public class Hive {
     ...
     *  ({@link org.cds.main.blockchain.vm.net.swarm.Hive.HiveTask#expireTime} and a limited number of
     *  peers to process ({@link org.cds.main.blockchain.vm.net.swarm.Hive.HiveTask#maxPeers}).
