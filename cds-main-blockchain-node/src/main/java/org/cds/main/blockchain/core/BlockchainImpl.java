...
import static org.cds.main.blockchain.core.ImportResult.EXIST;
import static org.cds.main.blockchain.core.ImportResult.IMPORTED_BEST;
import static org.cds.main.blockchain.core.ImportResult.IMPORTED_NOT_BEST;
import static org.cds.main.blockchain.core.ImportResult.INVALID_BLOCK;
import static org.cds.main.blockchain.core.ImportResult.NO_PARENT;
...
import org.cds.main.blockchain.db.PruneManager;
...
import org.cds.main.blockchain.trie.Trie;
import org.cds.main.blockchain.trie.TrieImpl;
import org.cds.main.blockchain.util.AdvancedDeviceUtils;
...
import org.cds.main.blockchain.vm.program.invoke.ProgramInvokeFactoryImpl;
...
@Component
public class BlockchainImpl implements Blockchain, org.cds.main.blockchain.facade.Blockchain {
...
//            Repository repoSnap = repository.getSnapshotTo(bestBlock.getStateRoot());
    ...
    private byte[] calculateGenerationSignature(byte[] lastGenSig, long lastGenId) {
    ...
    public synchronized Block createNewBlock(Block parent, List<Transaction> txs, List<BlockHeader> uncles, long time) {
        ...
        byte[] parenGenSign = parent.isGenesis()?new byte[32]:parent.getGenSign();
        byte[] genSign = calculateGenerationSignature(parenGenSign,Convert.addressToNumberic(parent.getCoinbase()));
        block.setGenSign(genSign);
        block.setBaseTarget(1);
        return block;
    }
