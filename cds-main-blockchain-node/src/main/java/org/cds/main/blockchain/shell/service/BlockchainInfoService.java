...
import org.cds.main.blockchain.shell.keystore.FileSystemKeystore;
import org.cds.main.blockchain.shell.util.BlockUtils;
import org.cds.main.blockchain.listener.RecommendedGasPriceTracker;
import org.cds.main.blockchain.util.BuildInfo;
import org.slf4j.LoggerFactory;
import ch.qos.logback.classic.Logger;
import org.cds.main.blockchain.shell.model.dto.*;
...
public class BlockchainInfoService implements ApplicationListener {
    ...
    public void onApplicationEvent(ApplicationEvent event) {
        if (event instanceof EmbeddedServletContainerInitializedEvent) {
            ...
            System.out.println("blockchain database dir location: " + systemProperties.databaseDir());
            System.out.println("blockchain keystore dir location: " + keystore.getKeyStoreLocation());
    ...
    private void createLogAppenderForMessaging() {
        ...
        Optional.ofNullable(root.getAppender("STDOUT"))
            .ifPresent(stdout -> {
            	if(StringUtils.equalsIgnoreCase(env.getProperty("blockchain.develop.mod"), "dev")){
            		return;
            	}
                stdout.stop();
