...
import static org.cds.main.blockchain.datasource.MemSizeEstimator.ByteArrayEstimator;
import static org.cds.main.blockchain.net.eth.EthVersion.V62;
import static org.cds.main.blockchain.net.message.ReasonCode.USELESS_PEER;
import static org.cds.main.blockchain.sync.PeerState.BLOCK_RETRIEVING;
import static org.cds.main.blockchain.sync.PeerState.DONE_HASH_RETRIEVING;
import static org.cds.main.blockchain.sync.PeerState.HEADER_RETRIEVING;
import static org.cds.main.blockchain.sync.PeerState.IDLE;
import static org.cds.main.blockchain.util.ByteUtil.toHexString;
import static org.cds.main.blockchain.util.Utils.longToTimePeriod;
...
import org.cds.main.blockchain.core.PendingState;
...
import org.cds.main.blockchain.net.eth.message.BlockBodiesMessage;
import org.cds.main.blockchain.net.eth.message.BlockHeadersMessage;
import org.cds.main.blockchain.net.eth.message.EthMessage;
import org.cds.main.blockchain.net.eth.message.GetBlockBodiesMessage;
import org.cds.main.blockchain.net.eth.message.GetBlockHeadersMessage;
import org.cds.main.blockchain.net.eth.message.NewBlockHashesMessage;
import org.cds.main.blockchain.net.eth.message.NewBlockMessage;
import org.cds.main.blockchain.net.eth.message.StatusMessage;
import org.cds.main.blockchain.net.eth.message.TransactionsMessage;
import org.cds.main.blockchain.net.message.ReasonCode;
import org.cds.main.blockchain.net.rlpx.discover.NodeManager;
import org.cds.main.blockchain.net.submit.TransactionExecutor;
import org.cds.main.blockchain.net.submit.TransactionTask;
import org.cds.main.blockchain.sync.PeerState;
import org.cds.main.blockchain.sync.SyncManager;
import org.cds.main.blockchain.sync.SyncStatistics;
...
public class Eth62 extends EthHandler {
    ...
    protected synchronized void processNewBlock(NewBlockMessage newBlockMessage) {
        ...
        if (!syncManager.validateAndAddNewBlock(newBlock, channel.getNodeId())) {
        	logger.info("Peer's Block {} is Bad,Drop Connection",newBlock.getShortDescr());
            dropConnection();
            return;
        }
