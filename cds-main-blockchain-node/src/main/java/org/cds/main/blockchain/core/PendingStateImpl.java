...
import static org.cds.main.blockchain.listener.EthereumListener.PendingTransactionState.DROPPED;
import static org.cds.main.blockchain.listener.EthereumListener.PendingTransactionState.INCLUDED;
import static org.cds.main.blockchain.listener.EthereumListener.PendingTransactionState.NEW_PENDING;
import static org.cds.main.blockchain.listener.EthereumListener.PendingTransactionState.PENDING;
...
import org.cds.main.blockchain.listener.EthereumListener.PendingTransactionState;
...
//        this.repository = blockchain.getRepository();
    ...
    private Block createFakePendingBlock() {
        ...
        Block block = new Block(best.getHash(),
                ...
                new byte[0],  // genSign (to mine)
                0,		      // targetBase (to mine)	
                0,  		  // nonce   (to mine)
